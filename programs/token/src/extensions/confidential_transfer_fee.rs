...
use super::{
    confidential_transfer::{EncryptedBalance, PodAeCiphertext, PodElGamalCiphertext},
...
pub struct WithheldTokensInfo {
    ...
    pub(crate) withheld_amount: PodElGamalCiphertext,
}
...
impl WithdrawWithheldTokensFromMint<'_> {
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        ...
        // -  [3...39]: new decryptable available balance (36 bytes, PodAeCiphertext)
