...
define_syscall!(fn sol_invoke_signed_c(instruction_addr: *const u8, account_views_addr: *const u8, account_views_len: u64, signers_seeds_addr: *const u8, signers_seeds_len: u64) -> u64);
define_syscall!(fn sol_invoke_signed_rust(instruction_addr: *const u8, account_views_addr: *const u8, account_views_len: u64, signers_seeds_addr: *const u8, signers_seeds_len: u64) -> u64);
